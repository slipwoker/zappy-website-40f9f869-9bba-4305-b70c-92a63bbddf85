    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יש חגיגה - אטרקציות ותוכן לאירועים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '40f9f869-9bba-4305-b70c-92a63bbddf85',
                    name: data.name || '',
                    email: data.email || '',
